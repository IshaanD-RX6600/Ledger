    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-3">
          ...
          <h2 className="text-lg font-semibold text-gray-900 leading-snug">{article.headline}</h2>
          {article.summary && (
            <p className="text-sm text-gray-600 leading-relaxed line-clamp-6">{article.summary}</p>
          )}
